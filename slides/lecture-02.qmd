...
![](../img/pliny.jpg){fig-align="center"}
...
![](../img/uncertainty.png){fig-align="center"}
...
![](../img/gollum-statistician.png){fig-align="center"}
...
<iframe allowfullscreen frameborder="0" height="100%" mozallowfullscreen style="min-width: 500px; min-height: 355px" src="https://app.wooclap.com/events/HUYFAK/questions/671a0fdebceee8af0026a35e" width="100%"></iframe>

##

<iframe allowfullscreen frameborder="0" height="100%" mozallowfullscreen style="min-width: 500px; min-height: 355px" src="https://app.wooclap.com/events/HUYFAK/questions/671a0fdedeac6802190f6db6" width="100%"></iframe>
...
The New Statistics ([Cumming 2014](https://doi.org/10.1177%2F0956797613504966)) mainly addresses **three problems**:
...
To learn more, check this [entry](https://uoelel.github.io/qml/posts/freq-bayes.html) from the QML course (Hons and MSc).

## Resources

**Courses and workshops**

- Quantitative Methods in Linguistics and English Language (Hons and MSc). Materials [here](https://uoelel.github.io/qml/).
- Stats workshops for intermediate and advanced users: STeW series (<https://uoelel.github.io/stew.html>).

**Textbooks**

- **Statistics for Linguists in R** by Bodo Winter.
- **Statistical Rethinking** by Richard McElreath.

**Important topics**

- Open Research/Scholarship practices.
- Regression modelling.

## Data Analysis at UoE LEL

### <https://uoelel.github.io>
